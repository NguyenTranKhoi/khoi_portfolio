...
import Avt from '../assets/av1.jpg'

const Home = () => {
  return (
    <div name='home' className='bg-[#0a192f] w-full h-screen'>
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center items-center h-full px-4 md:flex-row">
            <div>
            ...
            <img src={Avt} className='rounded-[50%] mx-auto w-2/5 md:w-[30%]' alt="" />
        </div>
